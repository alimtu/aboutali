...
import sakokImage from "../../assets/images/sakok.PNG";
...
const experienceCardData = [
  ...
  },
  {
    ...
    startedDate: "2021/10",
    timeDate: "2 month",
    link: "https://profiles.mazums.ac.ir/home",
  },
  {
    image: Seentra,
    bgColor: "#CED4DE",
  ...
  },
  {
    ...
    startedDate: "2022/03",
    timeDate: "1 month",
    link: "https://safa.mazums.ac.ir/",
  },
  {
    image: sakokImage,
    bgColor: "#B9FFF8",
    title: "Sakok",
    text: "Sakok CRM is a cloud system and its purpose is to integrate business activities and minimize their problems.",
    finishedDate: "-",
    startedDate: "2022/04",
    timeDate: "4 month",
    link: "https://sakok.com/",
  },
];
        ...
        <div style={{ minHeight: "80vh" }}>
          ...
          >
            ...
            <Col md={24} style={{ marginTop: 15 }}>
              ...
              >
                Most of these projects and other projects in the resume,
                including database, front-end and back-end, were designed and
                developed by myself.
              </Text>
            </Col>
            <Col
