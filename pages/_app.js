  ...
  return (
    <>
      <MetaComponent
        ...
        description="وبسایت شخصی علی منتظریون"
      />
      ...
      {!isSSR && (
        <PageContextProvider>
          <DefaultSeo
            title="Ali Montazerion"
            titleTemplate="علی منتظریون | منتظریون"
            robotsProps={{
              nosnippet: true,
              notranslate: true,
              noimageindex: true,
            ...
            openGraph={{
              ...
              title: "علی منتظریون | منتظریون",
              description: "علی منتظریون | منتظریون",
              type: "profile",
              profile: {
                firstName: "Ali",
            ...
            description="علی منتظریون | منتظریون - A site to introduce yourself to others and the possibility of ordering various projects by others"
